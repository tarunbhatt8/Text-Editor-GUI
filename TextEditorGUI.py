"""
Text Editor GUI
Submitted as Project for Summer Training in Acadview - Python Batch, Dehradun: May-June 2018
Code Credit: Tarun Bhatt , tarunbhatt.cse@gmail.com , DIT University Dehradun, Uttarakhand, India
Mentors:     Mr. Kanav Bansal , kanavbansal998@gmail.com ,
             Mr. Kavin Sharma , kavinsharma456@gmail.com ,
             Mr. Saket Kumar  , saket.bishu2@gmail.com
...
def display_about_messagebox(event=None):
    tkinter.messagebox.showinfo(
        "About", "{}{}".format(PROGRAM_NAME, "\nText Editor GUI\nAcadview: Tarun Bhatt\ntarunbhatt.cse@gmail.com"))
