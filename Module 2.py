...
Tkinter interface for Text editor
    ...
    Adding labels to hold shortcut toolbar and line number
"""
...
shortcut_bar = Frame(root,  height=25, background='spring green')
shortcut_bar.pack(expand='no', fill='x')

line_number_bar = Text(root, width=4, padx=3, takefocus=0,  border=0,
                       background='medium purple', state='disabled',  wrap='none')
